...
export const updateBoatAccessInformation = async (req, res, next) => {
    try {
        ...
        const updatedBoatAccessInfo = await BoatAccessInformation.findByIdAndUpdate(req.params.id, {
...
export const deleteBoatAccessInformation = async (req, res, next) => {
    try {
        const deletedBoatAccessInfo = await BoatAccessInformation.findByIdAndDelete(req.params.id);
