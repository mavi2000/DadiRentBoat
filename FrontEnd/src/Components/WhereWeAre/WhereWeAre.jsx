    ...
    <div>
      ...
      <div className=" mx-[6%] mt-[3%]">
        ...
        <p className="text-[#676767] text-lg">
          ...
          borders the Terrazza Mascagni, offering you breathtaking scenery that
          extends to the Meloria Park, further enriching the beauty of the
          surrounding panorama. Once you arrive, simply enter through the
          ...
          pool. Be sure to communicate that you have booked a boat at DaDi Rent
          and show your reservation for quick and easy pick-up. We await you in
          this elegant and regenerating place, where you can enjoy impeccable
          services and an enchanting view of the sea.
        </p>
        ...
        <div className="contact-information flex flex-col md:flex-row gap-[3%] my-[2%]">
          <div className=" flex flex-col gap-[2%] w-full md:w-[57%] mb-[2%]">
            ...
            <div className="bg-white where-shadow px-5 py-5 md:px-7 md:py-6 mb-[2%] rounded-xl md:min-h-52">
              ...
              <p className="pl-11 pr-8 pt-3">
                For the return of our vehicles, we ask you to call us 30 minutes
                before your return to the place of delivery, so that we can help
                you with the return
              </p>
            </div>
            ...
            <div className="bg-white where-shadow px-5 py-5 md:px-7 md:py-6 mb-[2%] rounded-xl md:min-h-52">
              ...
              <p className="pl-11 pr-8 pt-3">
                With our satellite tracking system we have the information about
                your exact location. In case of an emergency, we will find you
                with our safety boat and bring you back safely!
              </p>
            </div>
          </div>
        ...
        <div className=" flex flex-wrap gap-[2%] my-[2%]">
          <div className="px-8 py-8 md:pt-10 md:pr-10 md:pb-8 md:pl-12 where-shadow w-full md:w-[48%] mb-[2%] rounded-xl">
            <div className=" flex flex-col space-y-3">
              ...
              <p className=" text-base font-normal text-[#676767]">
                If you are looking for convenient and free parking, we recommend
                parking along Viale Italia, near the factory. Although you may
                notice some blue stalls along the seafront, on the stretch of
                Viale Italia from Bellana to Barriera Margherita, we want to
                reassure you that they are free for everyone. Paid parking will
                remain available at the Bellana car park, in Piazza Modigliani
                and Piazza San Jacopo. This option will allow you to easily
                reach our moorings, without worrying about additional costs.
                Have a good trip and enjoy your rental!
              </p>
            </div>
          </div>
          ...
          <div className="px-8 py-8 md:pt-10 md:pr-10 md:pb-8 md:pl-12 where-shadow w-full md:w-[48%] mb-[2%] rounded-xl">
            <div className=" flex flex-col space-y-3">
              ...
              <p className=" text-base font-normal text-[#676767]">
                Rates: €1.00 for the first two hours, €1.00 for each subsequent
                <br />
        ...
        <section className="bg-[#CBA5574D] mt-12 py-12 px-[3%] md:px-[6%] -mb-[3%]">
          ...
          <p className="text-lg text-[#383838]">
            ...
            of collection and delivery of the rented vehicle, even at home with
            a surcharge possibly to be agreed in the extra areas not indicated
            by the booking system. However, please note that the areas
            surrounding the pier of Ardenza is free. For special needs, home
            delivery, a surcharge will be granted based on the vehicle and
            frequency of the rental.
            <br />
            We can deliver, on multi-lingual bookings throughout the coast where
            foreseen, the possibility of approaching the coast due to the
            presence of authorized piers and landing lanes and ports. The
            surcharge will be granted based on the vehicle and frequency of the
            rental.
          </p>
          <br />
