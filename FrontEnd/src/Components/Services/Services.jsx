      ...
      <section className="flex flex-col-reverse md:flex-row mt-[4%]">
        ...
        <div className="bg-white z-10 w-full flex items-center gap-4 flex-col justify-center pb-8 self-end rounded-xl mt-5" >
          ...
          />
            ...
            <h1 className=' text-3xl font-medium text-[#383838]'>Rental with or without driver</h1>
         ...
         <button className=' self-start ml-[8%] border border-[#CBA557] py-3 px-10 rounded-lg text-[#CBA557]' >Find out More</button>
        </div>
      </section>
      ...
      <section className="flex flex-col-reverse md:flex-row mt-[4%]">
        ...
        <div className="bg-white z-10 w-full flex items-center gap-4 flex-col justify-center pb-8 self-end rounded-xl mt-5" >
          ...
          />
            ...
            <h1 className=' text-3xl font-medium text-[#383838]'>Fishing Trips</h1>
