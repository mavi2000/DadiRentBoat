    ...
    <>
      ...
      <ExcursionCard
        ...
        description={
          <>
            <p>
              Would you like to go on a boat and fish? Then you are in the right
              place for you. We at DaDi Rent organize fishing trips throughout
              the year.
            </p>
            <ul className="pl-8 list-disc">
              <li>
                You can plan outings with your friends on our rental dinghy with
                or without a skypper.
              </li>
              <li>
                You can take part in our excursions that we organize
                periodically, with the opportunity to make new friends.
              </li>
            </ul>
          </>
        }
