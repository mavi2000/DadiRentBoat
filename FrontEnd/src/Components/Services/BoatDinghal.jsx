...
<div>
    ...
    <div className='mx-[6%] mt-[5%] mb-[2%]'>
        <h1 className='text-3xl font-medium text-[#383838]'>Choose the rental that is best for you</h1>
       ...
       <div className='flex flex-wrap md:flex-nowrap gap-[2%] my-[2%]'>
        ...
        <div className='px-4 pt-8 pb-20 md:px-7 md:pt-12 md:pb-24 flex flex-col gap-5 shadow-sm rounded-[10px] bg-white md:w-1/2'>
          <img src={RentalDriver} alt="Rental Driver" className=' w-8 md:w-11' />
          <h2 className=' text-2xl leading-8 text-[#383838] font-medium'>Rental without driver</h2>
          <p className=' font-normal text-base leading-6 text-[#000000] text-opacity-50'>If you are looking for an adventure at sea, renting a dinghy is for you. Seven kilometers of uncontaminated coastline which hides caves and small bays of unparalleled beauty between beaches and cliffs.</p>
        ...
        <img src={RentalSkipper} alt="Rental Skipper" className=' w-8 md:w-11' />
        <h2 className=' text-2xl leading-8 text-[#383838] font-medium'>Rental with skipper on board</h2>
          <p className=' font-normal text-base leading-6 text-[#000000] text-opacity-50'>Do you want to experience the freedom and autonomy of a day on a dinghy but without having to worry about navigation rules, anchoring or the route? Do you want to just think about having fun without the slightest worry? So choose our "Rental with driver" formula.
          <br />
          Our skipper will take care of everything, the only thing left for you to do is relax and enjoy a memorable day on the <span className=' font-medium underline'>Read More.</span>
          </p>
       ...
       <div className=' flex justify-center'>
        <Link to={"/faq"} className='md:btn-5 rounded-[10px] bg-[#CBA557] py-3 px-8 my-[5%] text-white'>Click Here To Read The FAQ</Link>
       </div>
      ...
      <div className='px-4 pt-8 pb-20 md:px-7 md:pt-12 md:pb-10 flex flex-col gap-5 shadow-sm rounded-[5px] bg-white md:w-1/3 items-center'>
        <img src={WhereIcon} alt="Rental Driver" className=' w-8 md:w-14'/>
        <h2 className=' text-2xl leading-8 text-[#CBA557] font-medium font-[jost]'>Where we are</h2>
        <p className=' font-normal text-base leading-6 text-[#383838]'>You can find us at Bagni Pancaldi Acquaviva, in Viale Italia 62, in the heart of Livorno's seafront. It borders the Terrazza Mascagni, offering breathtaking scenery of the Tuscan islands and Corsica. In front of us, the Meloria Park extends, one of the closest points, further enriching the beauty of the surrounding panorama. An elegant and regenerating place with impeccable services and an enchanting view of the sea.</p>
      ...
      <h2 className=' text-2xl leading-8 text-[#CBA557] font-medium font-[jost]'>Our Means</h2>
        <p className=' font-normal text-base leading-6 text-[#383838]'>
      ...
      <div className='px-4 pt-8 pb-20 my-[3%] md:my-[0%] md:px-7 md:pt-12 md:pb-10 flex flex-col gap-5 shadow-sm rounded-[5px] bg-white md:w-1/3 items-center'>
      <img src={MeloriaSocial} alt="Rental Skipper" className=' w-8 md:w-14'/>
      <h2 className=' text-2xl leading-8 text-[#CBA557] font-medium font-[jost]'>Explore the Meloria Shoals</h2>
        <p className=' font-normal text-base leading-6 text-[#383838]'>
