...
const BookNow = () => {
  return (
    <div className='container flex mx-[6%] gap-[5%] mt-[2%]'>
      ...
      <div className="flex flex-wrap">
        ...
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Awning</p>
        </div>

        {/* Table */}
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Table</p>
        </div>

        {/* Sundeck */}
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Sundeck</p>
        </div>

        {/* Deck shower */}
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Deck shower</p>
        </div>

        {/* Free parking on site */}
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Free parking on site</p>
        </div>

        {/* Swim platform */}
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Swim platform</p>
        </div>

        {/* Outdoor cushions */}
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Outdoor cushions</p>
        </div>

        {/* MP3 player */}
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">MP3 player</p>
        </div>

        {/* Bluetooth Connection */}
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Bluetooth Connection</p>
        </div>

        {/* DVD player */}
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">DVD player</p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap">
        ...
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Socket 220V</p>
        </div>


        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">USB plug</p>
        </div>
      ...
      <div className="flex flex-wrap">
        ...
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">GPS</p>
        </div>


        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Sounder</p>
        </div>
        ...
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Electric windlass</p>
        </div>


        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Outboard engine</p>
        </div>
        ...
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Speedometer</p>
        </div>


        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Anemometer</p>
        </div>
        
        
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Compas</p>
        </div>
      ...
      <div className="flex flex-wrap">
        ...
        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Sunbed Rental</p>
        </div>


        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Umbrella Rental</p>
        </div>


        <div className="equip-items">
          <span className="text-[#CBA557]"><GiSpeedBoat/></span>
          <p className="text-[#000000] font-normal text-opacity-50">Swimming pool life guard</p>
        </div>
    ...
    <div className='mt-[4%]'>
      <h1 className='heading-book'>Things to know</h1>
        <div className=' mt-[3%] gap-3 flex'>
            <span className="text-[#CBA557] text-2xl"><PiDiamondsFourLight/></span>
            <p className='font-medium text-[#191919]'>Security Deposit <br className=' mb-[1%]'/>
            <p className=' text-sm font-normal text-opacity-70 text-[#4B465C]'>Please note that the rental fee does not Security Deposit costs.</p>
            </p>
        </div>

        <div className='mt-[3%] gap-3 flex'>
            <span className="text-[#CBA557] text-2xl"><PiDiamondsFourLight/></span>
            <p className='font-medium text-[#191919]'>Fuel excluded <br className=' mb-[1%]'/>
            <p className=' text-sm font-normal text-opacity-70 text-[#4B465C]'>Please note that the rental fee does not include fuel costs. Renters will be responsible for purchasing fuel separately during the rental period</p>
            </p>
        </div>

        <div className='mt-[3%] gap-3 flex'>
            <span className="text-[#CBA557] text-2xl"><PiDiamondsFourLight/></span>
            <p className='font-medium text-[#191919]'>Pre-Payment <br className=' mb-[1%]'/>
            <p className=' text-sm font-normal text-opacity-70 text-[#4B465C]'>30% pre-payment is required to confirm your booking.</p>
            </p>
        </div>

        <div className='mt-[3%] gap-3 flex'>
            <span className="text-[#CBA557] text-2xl"><PiDiamondsFourLight/></span>
            <p className='font-medium text-[#191919] leading-6'>Cancellation Policy for Boat and Dinghy Rentals in Livorno: 
            <br className=' mb-[1%]'/>
            <p className=' text-lg font-normal text-opacity-70 text-[#4B465C]'>Customer Impossibility</p>
            ...
            <p className=' text-lg font-normal text-opacity-70 text-[#4B465C] mt-1'>Bad weather:</p>
            <p className=' text-sm font-normal text-opacity-70 text-[#4B465C]'>
            Tenant's discretion to suspend rental service.
            If the service cannot be carried out due to bad weather or for reasons attributable to DaDi Rent, the customer has the right to recovery of the service on the first available date.
            </p>            
    ...
    <div className='mt-[4%]'>
      ...
      <p className=' mt-[3%] text-sm font-normal text-opacity-70 text-[#4B465C] leading-5'>You can find us at Bagni Pancaldi Acquaviva, located at Viale Italia 62, nestled in the heart of Livorno's seafront. Situated adjacent to the Terrazza Mascagni, our location offers stunning views of the Tuscan islands and Corsica. Facing us is the expansive Meloria Park, further enhancing the natural beauty of the surroundings. It's an elegant and rejuvenating spot with impeccable amenities and an enchanting sea view.
      At our establishment, customers have access to a range of services upon payment of an 8 Euro ticket. They can enjoy a refreshing shower upon their return, take advantage of the swimming pool, rent umbrellas and sun loungers, access the beach and children's play area, use the beach volleyball court for a quick match, or take a dip in Livorno's oldest and largest seaside establishment.</p>
    ...
    <div className='mt-[4%]'>
      ...
      <table className="border border-[#CBA557] bg-white rounded-lg w-1/2 sm:w-1/3 md:w-1/5 md:h-[294px] ">
        <thead>
          <tr>
            <th className="bg-[#CBA557] bg-opacity-30 text-sm text-[#000000]">January</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td className="text-sm font-normal">
              <div className="flex justify-between">
                ...
                <span className="text-sm font-normal text-[#676767]">$30</span>
              </div>
              <div className="flex justify-between">
      ...
      <table className="border border-[#CBA557] bg-white rounded-lg w-1/2 sm:w-1/3 md:w-1/5 md:h-[294px] ">
        <thead>
          <tr>
            <th className="bg-[#CBA557] bg-opacity-30 text-sm text-[#000000]">February</th>
          </tr>
        </thead>
        <tbody>
          <tr>
      ...
      <table className="border border-[#CBA557] bg-white rounded-lg w-1/2 sm:w-1/3 md:w-1/5 md:h-[294px] ">
        <thead>
          <tr>
            <th className="bg-[#CBA557] bg-opacity-30 text-sm text-[#000000]">March</th>
          </tr>
        </thead>
        <tbody>
          <tr>
      ...
      <table className="border border-[#CBA557] bg-white rounded-lg w-1/2 sm:w-1/3 md:w-1/5 md:h-[294px] ">
        <thead>
          <tr>
            <th className="bg-[#CBA557] bg-opacity-30 text-sm text-[#000000]">April</th>
          </tr>
        </thead>
        <tbody>
          <tr>
      ...
      <table className="border border-[#CBA557] bg-white rounded-lg w-1/2 sm:w-1/3 md:w-1/5 md:h-[294px] ">
        <thead>
          <tr>
            <th className="bg-[#CBA557] bg-opacity-30 text-sm text-[#000000]">May</th>
          </tr>
        </thead>
        <tbody>
          <tr>
      ...
      <table className="border border-[#CBA557] bg-white rounded-lg w-1/2 sm:w-1/3 md:w-1/5 md:h-[294px] ">
        <thead>
          <tr>
            <th className="bg-[#CBA557] bg-opacity-30 text-sm text-[#000000]">June</th>
          </tr>
        </thead>
        <tbody>
          <tr>
      ...
      <table className="border border-[#CBA557] bg-white rounded-lg w-1/2 sm:w-1/3 md:w-1/5 md:h-[294px] ">
        <thead>
          <tr>
            <th className="bg-[#CBA557] bg-opacity-30 text-sm text-[#000000]">July</th>
          </tr>
        </thead>
        <tbody>
          <tr>
      ...
      <table className="border border-[#CBA557] bg-white rounded-lg w-1/2 sm:w-1/3 md:w-1/5 md:h-[294px] ">
        <thead>
          <tr>
            <th className="bg-[#CBA557] bg-opacity-30 text-sm text-[#000000]">August</th>
          </tr>
        </thead>
        <tbody>
          <tr>
      ...
      <table className="border border-[#CBA557] bg-white rounded-lg w-1/2 sm:w-1/3 md:w-1/5 md:h-[294px] ">
        <thead>
          <tr>
            <th className="bg-[#CBA557] bg-opacity-30 text-sm text-[#000000]">September</th>
          </tr>
        </thead>
        <tbody>
          <tr>
      ...
      <table className="border border-[#CBA557] bg-white rounded-lg w-1/2 sm:w-1/3 md:w-1/5 md:h-[294px] ">
        <thead>
          <tr>
            <th className="bg-[#CBA557] bg-opacity-30 text-sm text-[#000000]">October</th>
          </tr>
        </thead>
        <tbody>
          <tr>
      ...
      <table className="border border-[#CBA557] bg-white rounded-lg w-1/2 sm:w-1/3 md:w-1/5 md:h-[294px] ">
        <thead>
          <tr>
            <th className="bg-[#CBA557] bg-opacity-30 text-sm text-[#000000]">November</th>
          </tr>
        </thead>
        <tbody>
          <tr>
      ...
      <table className="border border-[#CBA557] bg-white rounded-lg w-1/2 sm:w-1/3 md:w-1/5 md:h-[294px] ">
        <thead>
          <tr>
            <th className="bg-[#CBA557] bg-opacity-30 text-sm text-[#000000]">December</th>
          </tr>
        </thead>
        <tbody>
          <tr>
