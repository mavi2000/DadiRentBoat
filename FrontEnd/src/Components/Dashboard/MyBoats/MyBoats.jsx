  ...
  return (
    <div className=" mx-[4%] mt-[3%] ">
      ...
      <div className=" flex flex-col md:flex-row md:justify-between w-full mt-[3%]">
        <div className=" flex gap-[3%] flex-grow flex-col md:flex-row items-center">
          ...
          <div className=" flex flex-col gap-2 justify-center">
            <p className="text[#818C8E] font-normal text-sm text-center md:text-start">
              Jeanneau Albatros 750 - 2017
            </p>
            ...
            <div className="flex gap-2 my-[1%]">
              ...
              <div className="flex">
                <button className="px-4 py-2 border border-[#07474F] rounded-l-[4px]">
                  Edit your ad
                </button>
                <div className="p-1 border border-[#07474F] border-l-0 rounded-r-[4px] flex items-center">
                  <select
                    name=""
                    id=""
                    className="border-t bg-transparent text-xl"
                  >
                    <option value=""></option>
                  </select>
                </div>
            ...
            <div className=" flex gap-1 md:whitespace-nowrap">
              <p
                className=" text-xs font-normal text-[#FAB10A]"
                style={{ visibility: "hidden" }}
              >
                This announcement is not complete
              </p>
              <p
                className=" text-xs font-bold text-[#07474F]"
                style={{ visibility: "hidden" }}
              >
                • Complete the listing
              </p>
      ...
      <div class="flex items-center justify-between md:justify-start space-x-2 mt-[5%]">
        <button
          class="px-2 py-1 md:px-3 md:py-2  text-[#4B465C] text-opacity[8%] rounded-md bg-gray-200 hover:bg-gray-300 focus:outline-none focus:border focus:border-[#CBA557] focus:bg-[#CBA557] focus:text-[#FFFFFF] disabled:opacity-50"
          disabled
        >
          Previous
        </button>
        <button class="px-2 py-1 md:px-3 md:py-2  text-[#4B465C] text-opacity[8%] rounded-md bg-gray-200 hover:bg-gray-300 focus:outline-none focus:border focus:border-[#CBA557] focus:bg-[#CBA557] focus:text-[#FFFFFF]">
          1
        </button>
        <button class="px-2 py-1 md:px-3 md:py-2  text-[#4B465C] text-opacity[8%] rounded-md bg-gray-200 hover:bg-gray-300 focus:outline-none focus:border focus:border-[#CBA557] focus:bg-[#CBA557] focus:text-[#FFFFFF]">
          2
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-8 rounded-md space-y-3">
            <div className=" flex gap-2 items-center">
              ...
              <h2 className="text-[#4B465C] font-bold text-[15px]">
                Delete Boat
              </h2>
            </div>
            <p className="text-[#4B465C] text-[13px] font-normal">
              Are you sure you want to delete this boat?
            </p>
            <div className="flex gap-3">
              <button
                className=" px-4 py-2 bg-[#FF6347] text-white rounded"
