...
<>
  ...
  <tbody>
    ...
    <tr className="border-b border-[#DBDADE] hover:bg-gray-100">
      ...
      <td className="px-4 py-3 md:px-5 md:py-5 whitespace-nowrap text-sm text-[#4B465C]">
  <span
    className=' px-3 py-2 rounded-[10px] bg-[#0080001A] bg-opacity-10 text-[#008000] font-normal text-sm'
...
<td className="px-4 py-3 md:px-5 md:py-5 whitespace-nowrap text-sm text-[#4B465C]">
  ...
  >
    ...
    {infoBoxes[7] && (
      ...
      <td className="px-4 py-3 md:px-5 md:py-5 whitespace-nowrap text-sm text-[#4B465C]">
      <span className=' flex flex-col gap-6 items-start'>
        <span className=' px-3 py-2 rounded-[10px] bg-[#0080001A] bg-opacity-10 text-[#008000] font-normal text-sm'>
          Full Day Morning
        </span>
        <span className=' px-3 py-2 rounded-[10px] bg-[#0080001A] bg-opacity-10 text-[#008000] font-normal text-sm'>
          Full Day Morning
