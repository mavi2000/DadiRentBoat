...
const StatusDropdown = ({ status }) => {
  ...
  return (
    <Link
      ...
      className="absolute z-20 top-6 cursor-pointer right-0 text-[#676767] bg-white w-full rounded-md whitespace-nowrap text-center px-4 py-2 shadow-lg show-status hidden"
    >
