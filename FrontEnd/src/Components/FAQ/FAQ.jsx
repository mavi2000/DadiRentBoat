    ...
    <div>
      ...
      <div className="mx-[6%] mt-[4%] mb-[2%]">
        ...
        <p className="text-lg font-normal text-opacity-70 text-[#676767] mt-1 mb-[3%]">
          All the information you are looking for can be found here. If you have
          other questions, write to info@dadirectent.it or contact us on 370
          1564317
        </p>
        ...
        <p className="text-lg font-normal text-opacity-70 text-[#676767] mt-[2%]">
          Would you like to download the FAQ for further clarification? Click
          the button below to download the PDF file.
        </p>
