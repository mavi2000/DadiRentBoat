  ...
  return (
    <div className=" flex justify-center ">
      <div className=" mt-40 mb-20 w-[80%] ">
        <div className="flex  gap-2 w-[100%] text-gray-500 text-sm">
          <div>My Booking</div>
          <div>/</div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col justify-center items-center gap-2  w-[90%]   ">
                ...
                <div className="flex flex-col gap-1 w-[95%] ">
                  <div className="text-gray-700 text-sm font-medium">Zen</div>
                  <div className="text-gray-500 text-sm">
                ...
                <div className="flex flex-col gap-1 w-[95%] ">
                  <div className="text-gray-700 text-sm font-medium">Rigid</div>
                  <div className="text-gray-500 text-sm">
